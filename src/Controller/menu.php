    ...
    <section class="menu-section">
      ...
      <!-- TODOS OS PRATOS -->
        ...
        <form action="/menu" method="POST">
            ...
            <button type="submit" class="hamburger" id="hamburger">&#9776;">Enviar Pedido</button>
        </form>
      ...
      <div class="pedido-container">
        ...
        <div class="botoes">
          <button class="botao" class="hamburger" id="hamburger">&#9776;>Pedir na mesa</button>
          <button class="botao" class="hamburger" id="hamburger">&#9776;>Pedir Delivery</button>
        </div>
      </div>
    </section>
  </main>
